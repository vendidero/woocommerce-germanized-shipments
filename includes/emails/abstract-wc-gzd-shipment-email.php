...
abstract class WC_GZD_Shipment_Email extends WC_Email {

	/**
	 * Switch Woo and Germanized to site locale
	 */
	public function setup_locale() {
		if ( function_exists( 'wc_gzd_switch_to_site_locale' ) && $this->is_customer_email() && apply_filters( 'woocommerce_email_setup_locale', true ) ) {
	...
	public function restore_locale() {
		if ( function_exists( 'wc_gzd_restore_locale' ) && $this->is_customer_email() && apply_filters( 'woocommerce_email_restore_locale', true ) ) {
