...
if ( ! class_exists( 'WC_GZD_Email_New_Return_Shipment_Request', false ) ) :
	...
	class WC_GZD_Email_New_Return_Shipment_Request extends WC_Email {
		...
		public function get_default_subject() {
			return _x( '[{site_title}]: New return request to #{order_number}', 'shipments', 'woocommerce-germanized-shipments' );
		}
		...
		public function get_default_heading() {
			return _x( 'New return request to: #{order_number}', 'shipments', 'woocommerce-germanized-shipments' );
		}
