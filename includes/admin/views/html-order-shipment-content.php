...
<div class="shipment-content">
	<div class="columns">
		...
		<div class="column col-6">
			<div class="columns">
				<div class="column col-4">
					<p class="form-row">
						<label for="shipment-weight-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php printf( esc_html_x( 'Content (%s)', 'shipments', 'woocommerce-germanized-shipments' ), esc_html( $shipment->get_weight_unit() ) ); ?></label>
				...
				<div class="column col-8">
					<p class="form-row dimensions_field">
						<label for="shipment-length-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php printf( esc_html_x( 'Dimensions (%s)', 'shipments', 'woocommerce-germanized-shipments' ), esc_html( $shipment->get_dimension_unit() ) ); ?><?php echo wc_help_tip( _x( 'LxWxH in decimal form.', 'shipments', 'woocommerce-germanized-shipments' ) ); ?></label>
			...
			<p class="form-row wc-gzd-shipment-packaging-wrapper">
				<label for="shipment-packaging-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php echo esc_html_x( 'Packaging', 'shipments', 'woocommerce-germanized-shipments' ); ?></label>
		...
		<div class="column col-6">
			<p class="form-row">
				<label for="shipment-status-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php echo esc_html_x( 'Status', 'shipments', 'woocommerce-germanized-shipments' ); ?></label>
			...
			<?php if ( count( $shipment->get_available_shipping_methods() ) > 1 ) : ?>
				<p class="form-row">
					<label for="shipment-shipping-method-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php echo esc_html_x( 'Shipping method', 'shipments', 'woocommerce-germanized-shipments' ); ?></label>
			...
			<p class="form-row">
				<label for="shipment-shipping-provider-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php echo esc_html_x( 'Shipping provider', 'shipments', 'woocommerce-germanized-shipments' ); ?></label>
			...
			<p class="form-row show-if show-if-provider show-if-provider-is-manual">
				<label for="shipment-tracking-id-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php echo esc_html_x( 'Tracking Number', 'shipments', 'woocommerce-germanized-shipments' ); ?></label>
