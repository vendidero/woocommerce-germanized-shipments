...
<span class="item-count">
	...
	if ( ( $shippable_item_count = $shipment->get_shippable_item_count() ) > 0 ) :
		...
		?>
		<?php echo esc_html( sprintf( _nx( '%1$d of %2$d item', '%1$d of %2$d items', $shippable_item_count, 'shipments', 'woocommerce-germanized-shipments' ), $item_count, $shippable_item_count ) ); ?>
	<?php endif; ?>
</span>
