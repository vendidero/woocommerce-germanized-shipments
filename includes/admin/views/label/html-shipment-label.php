		...
		<div class="shipment-label-actions">
			...
			<?php else : ?>
				<div class="shipment-label-actions-wrapper shipment-label-actions-create">
					<a class="button button-secondary create-shipment-label" href="#" title="<?php echo esc_html_x( 'Create new label', 'shipments', 'woocommerce-germanized-shipments' ); ?>"><?php echo esc_html_x( 'Create label', 'shipments', 'woocommerce-germanized-shipments' ); ?></a>
