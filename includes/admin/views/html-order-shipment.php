...
<div id="shipment-<?php echo esc_attr( $shipment->get_id() ); ?>" class="order-shipment <?php echo ( $is_active ? 'active' : '' ); ?> <?php echo ( $shipment->is_editable() ? 'is-editable' : '' ); ?> <?php echo ( $shipment->needs_items() ? 'needs-items' : '' ); ?>" data-shipment="<?php echo esc_attr( $shipment->get_id() ); ?>">
    <div class="shipment-header title-spread">
        <div class="left">
            <h3><?php printf( _x( 'Shipment %s', 'shipments', 'woocommerce-germanized-shipments' ), '#' . $shipment->get_id() ); ?></h3>
