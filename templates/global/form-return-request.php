...
<form class="woocommerce-form woocommerce-form-return-request return-request" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		<label for="return-request-email"><?php echo esc_html_x( 'Order email', 'shipments', 'woocommerce-germanized-shipments' ); ?>&nbsp;<span class="required">*</span></label>
	...
	<p class="form-row">
		...
		<button type="submit" class="woocommerce-button button woocommerce-form-return_request__submit" name="return_request" value="<?php echo esc_attr_x( 'Submit', 'shipments', 'woocommerce-germanized-shipments' ); ?>"><?php echo esc_attr_x( 'Submit', 'shipments', 'woocommerce-germanized-shipments' ); ?></button>
	</p>
