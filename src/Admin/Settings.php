			...
			$pointers = array(
				'pointers' => array(
					'menu'    => array(
						...
						'next_trigger' => array(),
						'options'      => array(
							'content'  => '<h3>' . esc_html_x( 'Manage shipments', 'shipments', 'woocommerce-germanized-shipments' ) . '</h3><p>' . esc_html_x( 'To view all your existing shipments in a list you might follow this link or click on the shipments link within the WooCommerce sub-menu.', 'shipments', 'woocommerce-germanized-shipments' ) . '</p>',
							'position' => array(
								'edge'  => 'left',
								'align' => 'left',
							),
