...
class ShippingMethod extends \WC_Shipping_Method {
    ...
    public function admin_options() {
	    wp_localize_script(
		    ...
		    array(
			    'rules'                     => $this->get_instance_option( 'shipping_rules', array() ),
	...
	protected function generate_shipping_rules_html( $option_name, $option ) {
        ...
        $rule_types = $this->get_rule_types();
		?>
		<table class="wc_input_table widefat wc-gzd-shipments-shipping-rules">
			<thead>
				<tr>
					<th class="sort"></th>
					<th class="cb"></th>
        ...
        <script type="text/html" id="tmpl-wc-gzd-shipments-shipping-rules-row">
            <tr data-id="{{ data.rule_id }}">
                ...
                <td class="packaging">
                    <select class="wc-enhanced-select" name="<?php echo esc_attr( $field_key ); ?>[packaging][{{ data.rule_id }}]" data-attribute="packaging">
